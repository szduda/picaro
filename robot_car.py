...
class RobotCar:
  ...
  def __init__(self, motor_pins, frequency=100000):
  ...
  def get_acceleration(self):
    if RobotCar.MAX_DUTY_CYCLE in [
      self.left_motor_pin1.duty_u16(),
      self.right_motor_pin1.duty_u16()
    ]:
      return self.current_speed
